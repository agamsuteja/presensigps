                               ...
                               @foreach ($departemen as $d)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn group">     
                                                <form action="{{ route('departemen.delete', $d->kode_dept) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                 ...
                 <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" value="" id="nama_dept" class="form-control" name="nama_dept" placeholder="Departemen">
                          </div>
                    </div>
                 </div>
